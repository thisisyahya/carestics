...
//   // 3 Actual products from your store page
...
//     {
//       id: 3,
//       name: '3D Mounted Diecast Poster',
//       category: '3D Posters',
...
//   // Calculate combined sum total of all items
...
//       .map(
//         (p) =>
//           `• ${p.name} (Qty: ${p.quantity}) - Rs. ${p.discountedPrice * p.quantity}`
//       )
//       .join('\n');
...
//   return (
//     <main className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-emerald-100 selection:text-emerald-900 pb-16">
...
//             {/* Instructions Box Placed ABOVE the Entire Product Section */}
...
//                           {/* Item Quantity Selector & Dustbin Icon */}
...
//                   <Link href="/" className="text-xs font-bold text-amber-500 hover:text-amber-600 uppercase tracking-widest">
...
export default function CheckoutPage() {
  ...
  // Explicitly target "pieces" from the database, defaulting to Infinity if not found
